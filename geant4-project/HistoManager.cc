...
void HistoManager::Book()
{
  ...
  // id = 0
  analysisManager->CreateP1("TransDev_1L","Transverse development in absorber (mm)", 100, -0.5*mm, 30*mm, 0., 300.*MeV);
  // id = 1
  analysisManager->CreateP1("TransDev_5L","Transverse development in absorber (mm)", 100, -0.5*mm, 30*mm, 0., 300.*MeV);
  // id = 2
  analysisManager->CreateP1("TransDev_10L","Transverse development in absorber (mm)", 100, -0.5*mm, 30*mm, 0., 300.*MeV);
  // id = 3
  analysisManager->CreateP2(
    "TransDev_2D","Transverse and longitudinal development in absorber (mm)",
    2000, -0.5*cm, 0.5*cm,
    2000, -0.5*cm, 0.5*cm,
    0., 300.*MeV
  );
