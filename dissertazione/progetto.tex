...
Vi sono anche GAN (dette Conditional GAN), come quella sviluppata per questa dissertazione, che consentono di modificare alcuuni parametri per generare campioni di un certo tipo.
