...
// Tue Oct 12 11:26:17 2021 by ROOT version 6.24/02
// from TTree CRT/CRT
// found on file: run165_ana.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run165_ana.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run165_ana.root");
      }
